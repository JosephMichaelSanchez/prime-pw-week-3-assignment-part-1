...
let favoriteFoods = ['shrimp', 'crab', 'scallops', 'fries'];
...
let finalFood = favoriteFoods.pop();
console.log('I have removed', finalFood, 'from the array');
...
console.log('The new foods are now', favoriteFoods);
